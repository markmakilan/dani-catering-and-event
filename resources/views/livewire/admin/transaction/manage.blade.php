<div x-data="transaction">
    <div class="flex items-center justify-between mb-5">
        ...
        <div class="flex items-center gap-2">
            ...
            <button class="bg-black rounded-lg px-3 py-1.5" wire:click="updateRemarks('cancelled')">
    ...
    <div class="bg-white rounded-lg p-3 space-y-3">
        ...
        <table class="min-w-full divide-y divide-gray-300">
            <thead>
                <tr>
                    <th colspan="5" class="px-3 py-1 bg-black text-left text-sm font-semibold text-white">Addons</th>
                </tr>
                <tr>
                    <th scope="col" class="px-3 py-2 bg-gray-200 text-left text-sm font-semibold text-gray-900">Name</th>
                    <th scope="col" class="px-3 py-2 bg-gray-200 text-left text-sm font-semibold text-gray-900">Type</th>
                    <th scope="col" class="px-3 py-2 bg-gray-200 text-left text-sm font-semibold text-gray-900">Price</th>
                    <th scope="col" class="px-3 py-2 bg-gray-200 text-left text-sm font-semibold text-gray-900">Quantiy</th>
                    <th scope="col" class="px-3 py-2 bg-gray-200 text-left text-sm font-semibold text-gray-900">Total</th>
                </tr>
            </thead>
                ...
                @foreach ($transaction->addons as $type => $addon)
                    @foreach ($addon as $item)
                        ...
                        <tr>
                            ...
                            <td class="px-3 py-2 text-sm text-gray-500">₱ {{ number_format($item->price * $item->quantity, 2) }}</td>
                        </tr>
                        @endif
                    @endforeach
                @endforeach
            ...
            <tfoot>
                <tr>
                    ...
                    <th class="px-3 py-1 bg-black text-left text-sm font-semibold text-white">₱ {{ number_format($transaction->addons_total_amount, 2) }}</th>
                </tr>
            </tfoot>
        </table>
        @endif
